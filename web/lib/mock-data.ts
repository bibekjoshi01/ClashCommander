...
export const actualBackendResponse: BackendScanResponse = {
  ...
  issues: [
    {
      ...
      description:
        "The site loads as a blank white screen with 5 aborted network requests for critical resources (e.g., /roadmap/*). No console errors or visible content.",
      steps_to_reproduce: [
    ...
    },
    {
      ...
      description:
        "Critical security headers (CSP, X-Content-Type-Options, X-Frame-Options, Referrer-Policy, Permissions-Policy) are missing. Cookie CONTEXT_TYPE lacks Secure, HttpOnly, and SameSite flags.",
      steps_to_reproduce: [
    ...
    },
    {
      ...
      description:
        "10 interactive elements (e.g., buttons, links) have touch targets smaller than the WCAG-recommended 44x44px minimum.",
      steps_to_reproduce: [
    ...
    },
    {
      ...
      description:
        "1 form field is missing an accessible label (e.g., aria-label, aria-labelledby, or <label>), violating WCAG 3.3.2.",
      steps_to_reproduce: [
        "Load the page (if content were visible).",
  ...
  tool_outputs: [
    ...
    },
    {
      success: true,
      output:
        '{"url": "https://www.tabflux.com/", "snapshot": {"title": "TABFlux - Bridge the Gap. Build Your Tech Future | TABFlux", "total_elements": 276, "links": 18, "forms": 0, "images": 2, "missing_alt_images": 0, "small_touch_targets": 10, "unlabeled_form_controls": 1, "insecure_form_actions": 0, "inline_script_blocks": 16, "mixed_content_references": 0}, "findings": ["Touch targets below 44x44 detected.", "Form fields without accessible labels detected.", "High number of inline scripts; check CSP/XSS hardening."]}',
      error: null,
      screenshot_base64: null,
      metadata: {
        url: "https://www.tabflux.com/"
    ...
    },
    {
      success: true,
      output:
        '{"url": "https://www.tabflux.com/", "metrics": {"ttfb_ms": 41, "dom_content_loaded_ms": 456.89999997615814, "load_event_ms": 3218.100000023842, "fcp_ms": 652, "resource_count": 61}, "findings": []}',
      error: null,
      screenshot_base64: null,
      metadata: {
        url: "https://www.tabflux.com/"
...
export function createMockReport(payload: ScanPayload): ScanReport {
  const backendShape: BackendScanResponse = {
    ...actualBackendResponse,
    url: payload.targetUrl || actualBackendResponse.url,
    issues: actualBackendResponse.issues.map((issue) => ({
      ...issue
    })),
    tool_outputs: actualBackendResponse.tool_outputs.map((item) => ({
      ...item,
      metadata: {
        ...item.metadata,
        url: payload.targetUrl || actualBackendResponse.url
  ...
  return backendToScanReport(backendShape);
}
